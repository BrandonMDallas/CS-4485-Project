...
function StockFunc() {
  const [disabledV, setDisabledV] = useState([
    false,
    false,
    false,
    false,
  ...
  async function getRate() {
    await Axios.get(
      `https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=${currencyName[0]}&to_currency=${currencyName[1]}&apikey=7RZVY7KZE49Y3X1S`
    ).then((response) => {
  ...
  async function getVideos() {
    await Axios.get(
      `https://youtube.googleapis.com/youtube/v3/search?key=AIzaSyCZh-67g2M5u0LDKyXYHCTweVp1mjZDisU&part=snippet&q=stocks news`
    ).then((response) => {
  ...
  async function getRelatedVideos(value) {
    await Axios.get(
      `https://youtube.googleapis.com/youtube/v3/search?key=AIzaSyCZh-67g2M5u0LDKyXYHCTweVp1mjZDisU&part=snippet&q=stocks news ${value}`
    ).then((response) => {
      const parsedData = JSON.parse(JSON.stringify(response));
  ...
  let index = 0;
  let variable1 =
    "https://assets.parqet.com/logos/symbol/" + companies[0] + "?format=png";
  let variable2 = "";
  const [buttonList, setButtonList] = useState([]);

  const [checkedItems, setCheckedItems] = useState(list1.map((item) => false));
  ...
  async function getStock(value, value2, value3, id) {
    ...
    await Axios.get(
      `https://www.alphavantage.co/query?function=${value3}&symbol=${value}&${value4}outputsize=full&apikey=7RZVY7KZE49Y3X1S`
    ).then((response) => {
  ...
  async function getComp(value) {
    await Axios.get(
      `https://www.alphavantage.co/query?function=OVERVIEW&symbol=${value}&apikey=7RZVY7KZE49Y3X1S`
    ).then((response) => {
      const parsedData = JSON.parse(JSON.stringify(response));
  ...
  const addbutton = (index) => {
    const newButton = (
      <button style={{ borderRadius: "10px" }}>{companies[index]}</button>
    );
      ...
      .then((json) => {
        const results = json.filter((user) => {
          return (
            ...
            user.name
              .toLowerCase()
              .includes(value /*value entered into the search field */)
          );
        });
  ...
  const [diffArray, setDiffArray] = useState([
    dataPoints2[0] - dataPoints[1],
    dataPoints3[0] - dataPoints[1],
    dataPoints4[0] - dataPoints4[1],
    dataPoints5[0] - dataPoints[1],
    dataPoints6[0] - dataPoints6[1],
  ]);
  let tempArray10 = [];

  async function changeDataCond() {
    await Axios.get(
      `https://financialmodelingprep.com/api/v3/stock_market/actives?apikey=xN4lrLuDYQNI6EV4mSbwXUZY7xek4Fj7`
    ).then((response) => {
      const parsedData = JSON.parse(JSON.stringify(response));
  ...
  async function getSR(event) {
    ...
    await Axios.get(
      `https://financialmodelingprep.com/api/v3/search?query=${inputValue}&apikey=xN4lrLuDYQNI6EV4mSbwXUZY7xek4Fj7`
    ).then((response) => {
      const parsedData = JSON.parse(JSON.stringify(response));
  ...
  async function getER() {
    await Axios.get(
      "https://www.alphavantage.co/query?function=NEWS_SENTIMENT&tickers=NKE&apikey=7RZVY7KZE49Y3X1S"
    ).then((response) => {
      try {
        const parsedData = JSON.parse(JSON.stringify(response));
        ...
        setlER(
          parsedData["Realtime Currency Exchange Rate"]["5. Exchange Rate"]
        );
        console.log(lER);
        ...
        <div style={{ display: "flex", gap: "400px" }}>
          <div style={{ display: "flex" }}>
            <Link to="/dashboard">
              ...
              >
                <img
                  src="https://cdn-icons-png.flaticon.com/512/81/81037.png"
                  width="20px"
                  height="20px"
                />
              </div>
...
<div style={{position: 'absolute', right: '1%'}}>
      ...
      <br></br>
      <p class="lead">
        Today's date and time: {displayDate} {currTime.toLocaleTimeString()}
      </p>
      <br></br>
        ...
        <div class="moreSection" id="listSection" style={{ width: "65%" }}>
          ...
          >
            <h6 class="h6" style={{ fontWeight: "bold", fontSize: "30px" }}>
              Top 10 currently active stocks
            </h6>
            <div class="card-body">
              <p class="lead">
            ...
            <ul class="list-group">
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as1, asP1, asC1, asS1)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as2, asP2, asC2, asS2)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as3, asP3, asC3, asS3)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as4, asP4, asC4, asS4)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as5, asP5, asC5, asS5)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as6, asP6, asC6, asS6)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as7, asP7, asC7, asS7)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as8, asP8, asC8, asS8)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as9, asP9, asC9, asS9)}
                >
                  Save stock
                </Button>
                <br></br>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => addLike(as10, asP10, asC10, asS10)}
                >
                  Save stock
                </Button>
                <br></br>
            ...
            <Modal show={show5} onHide={handleClose5}>
              <Modal.Header closeButton>
                <Modal.Title>
                  About this stock: {companies[dSelect]}
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>Information goes here</Modal.Body>
              <Modal.Footer>
        ...
        <div style={{ height: "450px", width: "400px" }}>
          <div
            ...
            style={{
              ...
              borderRadius: "8px",
              borderColor: "black",
              boxShadow: "5px 5px 10px rgba(21, 61, 219, 0.76)",
              padding: "10px",
              textAlign: "center",
            }}
          >
            ...
            <img
              style={{ borderRadius: "10px" }}
              src="https://cdn.dribbble.com/userupload/22460781/file/original-73dfd4921f8852c03728693bee46deb0.gif"
              width="50%"
              height="50%"
            />{" "}
            <br></br>
          ...
          >
            <h3 style={{ color: "black", textAlign: "center" }}>
              Get current exchange rates here
            </h3>
            <div
              style={{
                display: "flex",
            ...
            >
              <Dropdown>
                ...
                <Dropdown.Menu>
                  <Dropdown.Item
                    onClick={() => setCurrencyName(["USD", currencyName[1]])}
                  >
                    American Dollar
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName(["GBP", currencyName[1]])}
                  >
                    British Pound
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName(["EUR", currencyName[1]])}
                  >
                    Euro
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName(["CAD", currencyName[1]])}
                  >
                    Canadian Dollar
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName(["JPY", currencyName[1]])}
                  >
                    Japanese Yen
                  </Dropdown.Item>
                </Dropdown.Menu>
              ...
              <Dropdown>
                ...
                <Dropdown.Menu>
                  <Dropdown.Item
                    onClick={() => setCurrencyName([currencyName[0], "USD"])}
                  >
                    American Dollar
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName([currencyName[0], "GBP"])}
                  >
                    British Pound
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName([currencyName[0], "EUR"])}
                  >
                    Euro
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName([currencyName[0], "CAD"])}
                  >
                    Canadian Dollar
                  </Dropdown.Item>
                  <Dropdown.Item
                    onClick={() => setCurrencyName([currencyName[0], "JPY"])}
                  >
                    Japanese Yen
                  </Dropdown.Item>
                </Dropdown.Menu>
            ...
            <button
              ...
              onClick={() => getRate()}
            >
              <div style={{ textAlign: "center" }}>Calculate rate</div>
            </button>
            <br></br>
            <p>Result: {eRate}</p>
          </Card>
      ...
      >
        <div style={{ width: "120%" }}>
          ...
          >
            ...
            <Modal show={show4} onHide={handleClose4}>
              ...
              <Modal.Body>
                ...
                <Link to="/aifinance">
                  {" "}
                  <Button style={{ borderRadius: "10px" }}>
                    How well I'm doing with my finances so far
                  </Button>
                </Link>
                <br></br>
                <Link to="/improveStocks">
                  <Button style={{ borderRadius: "10px" }}>
                    How I can improve my investing
                  </Button>
                </Link>
              </Modal.Body>
              <Modal.Footer></Modal.Footer>
            ...
            <br></br>
            <p class="lead">
              Pick a time span that the graph below will display
            </p>
            ...
            <ul
              ...
              id="pills-tab"
              role="tablist"
              style={{ display: "block", margin: "auto", float: "middle" }}
            >
              {
                <li
                  class="nav-item"
      ...
      >
        ...
        <div style={{ display: "flex", gap: "13px" }}>
          <div>
            ...
            <div id="videoSection">
              <h3 style={{ color: "blue", display: "block" }}>
                Videos related to {currentGraph}
              </h3>
              <div>
                <iframe
                  width="560"
            ...
            >
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>{newsBody[0]}</Card.Text>
                  <Button variant="primary" onClick={() => handleShow6(0)}>
                    More information
                  </Button>
                </Card.Body>
              </Card>
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>{newsBody[1]}</Card.Text>
                  <Button variant="primary" onClick={() => handleShow6(1)}>
                    More information
                  </Button>
                </Card.Body>
              </Card>
            ...
            >
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>{newsBody[3]}</Card.Text>
                  <Button variant="primary" onClick={() => handleShow6(3)}>
                    More information
                  </Button>
                </Card.Body>
              </Card>
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>{newsBody[4]}</Card.Text>
                  <Button variant="primary" onClick={() => handleShow6(4)}>
                    More information
                  </Button>
                </Card.Body>
              </Card>
              ...
              >
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[6]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(6)}>
                      More information
                    </Button>
                  </Card.Body>
                </Card>
                ...
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[7]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(7)}>
                      More information
                    </Button>
                  </Card.Body>
                </Card>
              ...
              >
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[9]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(9)}>
                      More information
                    </Button>
                  </Card.Body>
                </Card>
                ...
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[10]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(10)}>
                      More information
                    </Button>
                  </Card.Body>
                </Card>
              ...
              >
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[11]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(9)}>
                      More information
                    </Button>
                  </Card.Body>
                ...
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[12]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(10)}>
                      More information
                    </Button>
                  </Card.Body>
              ...
              >
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[13]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(9)}>
                      More information
                    </Button>
                  </Card.Body>
                ...
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[14]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(10)}>
                      More information
                    </Button>
                  </Card.Body>
              ...
              >
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[15]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(9)}>
                      More information
                    </Button>
                  </Card.Body>
                ...
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[16]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(10)}>
                      More information
                    </Button>
                  </Card.Body>
              ...
              >
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[17]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(9)}>
                      More information
                    </Button>
                  </Card.Body>
                ...
                <Card style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>{newsBody[18]}</Card.Text>
                    <Button variant="primary" onClick={() => handleShow6(10)}>
                      More information
                    </Button>
                  </Card.Body>
